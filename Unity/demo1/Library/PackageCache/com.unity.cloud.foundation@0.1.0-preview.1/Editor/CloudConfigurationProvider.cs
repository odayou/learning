...
{
    internal class CloudConfigurationProvider : SettingsProvider
    {
        ...
        public CloudConfigurationProvider(string path, string buildSettingsKey, Type buildDataType, SettingsScope scopes = SettingsScope.Project) : base(path, scopes)
        {
        ...
        ScriptableObject Create()
        {
            ...
            if (settings != null)
            {
                var package = CloudPackageMetadataStore.GetPackageForSettingsTypeNamed(m_BuildDataType.FullName);
