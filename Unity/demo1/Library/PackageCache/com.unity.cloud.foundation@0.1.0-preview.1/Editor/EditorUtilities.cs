...
namespace UnityEditor.Cloud.Foundation
{
    ...
    {
        internal static readonly string[] s_DefaultGeneralSettingsPath = {"Cloud"};
        internal static readonly string[] s_DefaultLoaderPath = {"Cloud","Loaders"};
        internal static readonly string[] s_DefaultSettingsPath = {"Cloud","Settings"};
        ...
        internal static ScriptableObject CreateScriptableObjectInstance(string typeName, string path)
        {
            ...
            Debug.LogError($"We were unable to create an instance of the requested type {typeName}. Please make sure that all packages are updated to support this version of Cloud Plug-In Management. See the Unity documentation for Cloud Plug-In Management for information on resolving this issue.");
            return null;
        }
