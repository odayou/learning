...
using UnityEngine;
using Styles = UnityEditor.Cloud.Foundation.CloudSettingsManager.Styles;
...
namespace UnityEditor.Cloud.Foundation
{
    ...
    public class PackageNotificationInfo
    {
        ...
        /// <summary>
        /// Constructs a container for package notification information that displays in the Cloud Foundation window.
        /// </summary>
        /// <param name="userInterfaceIcon">
        /// The <c>GUIContent</c> icon to display in the Cloud Foundation window.  If the tooltip of this
    ...
    public static class PackageNotificationUtils
    {
        ...
        /// The metadata identifier for a given package <see cref="ICloudPackageMetadata.packageId"/>
        /// </param>
