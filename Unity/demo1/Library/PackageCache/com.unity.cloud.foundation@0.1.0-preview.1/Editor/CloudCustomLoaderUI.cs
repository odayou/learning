...
{
    /// <summary>
    /// Custom attribute that indicates a class supports the <see cref="ICloudCustomLoaderUI"/> for a
    /// specific loader and build target group. Any class marked with this attribute will
    /// have <see cref="ICloudCustomLoaderUI"/> methods called on it while the Cloud Plug-in Management UI is displaying
    ...
    public class CloudCustomLoaderUIAttribute : Attribute
    {
        /// <summary>
        ...
        private  CloudCustomLoaderUIAttribute() {}
        ...
        public CloudCustomLoaderUIAttribute(string loaderTypeName, BuildTargetGroup buildTargetGroup)
        {
    ...
    /// its own UI in the Cloud Plug-in Management loader selection
    /// window.
    ///
    /// Any class that implements this interface must be tagged with the <see cref="CloudCustomLoaderUIAttribute"/> attribute.
    /// </summary>
    public interface ICloudCustomLoaderUI
    {
        /// <summary>
        ...
        /// <summary>
        ///  Allows Cloud Plug-in Management to tell the UI which build target group it's being used with.
        /// </summary>
