...
namespace UnityEditor.Cloud.Foundation.Tests
{
    class MetadataTests
    {
        ...
        public IEnumerator CreateSettingsAndLoaders()
        {
            ...
            string[] assetTypes = new string[]{"TestLoaderOne","TestSettings"};
        ...
        public void FilteringMetadataByBuildTargetGroup(
            [Values(BuildTargetGroup.Standalone)]BuildTargetGroup buildTargetGroup,
            [Values("Test Loader One")]string expectedType)
        {
        ...
        public IEnumerator AccessSettings()
        {
            ...
            var metadata = CloudPackageMetadataStore.GetMetadataForPackage("com.unity.cloud.testpackage");
