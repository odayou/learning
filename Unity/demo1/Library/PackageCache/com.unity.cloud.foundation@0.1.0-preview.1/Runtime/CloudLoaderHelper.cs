...
{
    /// <summary>
    /// Cloud Loader abstract subclass used as a base class for specific provider implementations. Class provides some
    /// helper logic that can be used to handle subsystem handling in a typesafe manner, reducing potential boilerplate
    /// code.
    /// </summary>
    public abstract class CloudLoaderHelper : CloudLoader
    {
        /// <summary>
        /// Map of loaded susbsystems. Used so we don't always have to fo to CloudSubsystemManger and do a manual
        ...
        /// <summary>
        /// Override of <see cref="CloudLoader.Deinitialize"/> to provide for clearing the instance map.true
        ///
