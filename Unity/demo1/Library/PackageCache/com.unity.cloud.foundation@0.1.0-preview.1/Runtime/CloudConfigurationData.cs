...
{
    /// <summary>
    /// This attribute is used to tag classes as providing build settings support for an Cloud provider. The unified setting system
    ...
    public sealed class CloudConfigurationDataAttribute : Attribute
    {
        /// <summary>
        ...
        private CloudConfigurationDataAttribute() {}
        ...
        public CloudConfigurationDataAttribute(string displayName, string buildSettingsKey)
        {
